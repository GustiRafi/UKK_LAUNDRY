...
Route::middleware('auth')->group(function(){
    Route::resource('/account',App\Http\Controllers\userController::class)->middleware('admin');
    Route::resource('/outlet', App\Http\Controllers\outletController::class)->middleware('admin');
    Route::resource('/membership', App\Http\Controllers\memberController::class)->middleware('admin','kasir');
    Route::resource('/paket', App\Http\Controllers\paketController::class)->middleware('admin');
